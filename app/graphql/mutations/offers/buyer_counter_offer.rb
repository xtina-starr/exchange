class Mutations::Offers::BuyerCounterOffer < Mutations::BaseMutation
  ...
  def resolve(offer_id:, amount_cents:)
    ...
    add_service = ::Offers::AddPendingCounterOfferService.new(offer, amount_cents: amount_cents, from_type: Order::USER, from_id: current_user_id, creator_id: current_user_id)
    add_service.process!

class Mutations::CreateInquiryOfferOrderWithArtwork < Mutations::BaseMutation
  null true
  ...
  argument :impulse_conversation_id, String, 'Impulse conversation id corresponding to an order.', required: true
  ...
  def resolve(artwork_id:, find_active_or_create:, impulse_conversation_id:, edition_set_id: nil, quantity: 1)

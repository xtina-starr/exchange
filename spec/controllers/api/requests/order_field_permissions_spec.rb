...
describe Api::GraphqlController, type: :request do
  describe 'order query field permissions' do
    ...
    let(:user_id) { 'user-i' }
    let!(:order) { Fabricate(:order, seller_id: partner_id, buyer_id: user_id, updated_at: 1.day.ago, shipping_total_cents: 100_00, commission_fee_cents: 30_00, transaction_fee_cents: 20_00,  items_total_cents: 1000_00, buyer_total_cents: 1100_00, seller_total_cents: 1050_00) }
    context 'as buyer' do
      let(:jwt_partner_ids) { [] }

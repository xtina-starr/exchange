      ...
      context 'with offers' do
        ...
        let!(:buyer_offer) do
          Fabricate(
            ...
            submitted_at: Date.new(2018, 1, 1)
          )
        end
        let!(:seller_offer) do
          Fabricate(

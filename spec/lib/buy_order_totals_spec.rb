    ...
    context 'with single line item' do
      context 'no exemption' do
        it 'returns commission from order' do
          buy_order_totals =
            BuyOrderTotals.new(order, commission_exemption_amount_cents: nil)
      ...
      context 'exemption is 0' do
        it 'returns commission from order' do
          buy_order_totals =
            BuyOrderTotals.new(order, commission_exemption_amount_cents: 0)
        ...
        context 'exemption is < line item price' do
          it 'returns commission with partial exemption' do
            buy_order_totals =
              BuyOrderTotals.new(
                order,
                commission_exemption_amount_cents: 100_00
              )
        ...
        context 'exemption is > line item price' do
          it 'returns 0 commission' do
            buy_order_totals =
              BuyOrderTotals.new(
                order,
                commission_exemption_amount_cents: 2000_00
              )
        ...
        context 'with commission exemption larger than any individual line item' do
          it 'updates commission on order totals' do
            buy_order_totals =
              BuyOrderTotals.new(
                order,
                commission_exemption_amount_cents: 1500_00
              )
        ...
        context 'with commission exemption equal to the total of all line items' do
          it 'updates commission on order totals' do
            buy_order_totals =
              BuyOrderTotals.new(
                order,
                commission_exemption_amount_cents: 3000_00
              )

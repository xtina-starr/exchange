  ...
  describe 'commission_fee_cents' do
    context 'no exemption' do
      it 'returns commission based on offer and commission rate' do
        offer_order_totals =
          OfferOrderTotals.new(offer, commission_exemption_amount_cents: nil)
    ...
    context 'exemption is 0' do
      it 'returns commission based on offer and commission rate' do
        offer_order_totals =
          OfferOrderTotals.new(offer, commission_exemption_amount_cents: 0)
    ...
    context 'exemption is > 0' do
      it 'returns commission including exemption' do
        offer_order_totals =
          OfferOrderTotals.new(offer, commission_exemption_amount_cents: 100_00)

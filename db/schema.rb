...
ActiveRecord::Schema.define(version: 2020_03_06_192634) do
  ...
  create_table 'fulfillment_versions', force: :cascade do |t|
    ...
    t.index %w[item_type item_id],
            name: 'index_fulfillment_versions_on_item_type_and_item_id'
  end

  create_table 'fulfillments',
               id: :uuid,
               default: -> { 'gen_random_uuid()' },
               force: :cascade do |t|
    t.string 'courier'
  ...
  create_table 'line_item_fulfillments',
               id: :uuid,
               default: -> { 'gen_random_uuid()' },
               force: :cascade do |t|
    t.uuid 'line_item_id'
    ...
    t.index ['fulfillment_id'],
            name: 'index_line_item_fulfillments_on_fulfillment_id'
    t.index ['line_item_id'],
            name: 'index_line_item_fulfillments_on_line_item_id'
  end
  ...
  create_table 'line_item_versions', force: :cascade do |t|
    ...
    t.datetime 'created_at'
    t.index %w[item_type item_id],
            name: 'index_line_item_versions_on_item_type_and_item_id'
  end
  ...
  create_table 'offer_versions', force: :cascade do |t|
    ...
    t.datetime 'created_at'
    t.index %w[item_type item_id],
            name: 'index_offer_versions_on_item_type_and_item_id'
  end
  ...
  create_table 'order_versions', force: :cascade do |t|
    ...
    t.jsonb 'object_changes'
    t.index %w[item_type item_id],
            name: 'index_order_versions_on_item_type_and_item_id'
  end
  ...
  create_table 'transaction_versions', force: :cascade do |t|
    ...
    t.datetime 'created_at'
    t.index %w[item_type item_id],
            name: 'index_transaction_versions_on_item_type_and_item_id'
  end
